import { getTweets, getUserTweets, writeTweets, writeTweet } from '../util/tweet_api_util';
export const RECEIVE_TWEETS = 'RECEIVE_TWEETS';
export const RECEIVE_USER_TWEETS = 'RECEIVE_USER_TWEETS';
export const RECEIVE_NEW_TWEETS = 'RECEIVE_NEW_TWEETS';
